...
function toggleChapter(id){
  ...
  if(!p) return;
  if(p.classList.contains('hidden')){ p.classList.remove('hidden'); if(c) c.style.transform='rotate(0deg)'; }
  else { p.classList.add('hidden'); if(c) c.style.transform='rotate(-90deg)'; }
}
