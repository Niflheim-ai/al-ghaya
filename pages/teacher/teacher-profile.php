...
// Handle form submission for profile update (basic info only - excluding email and password)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    ...
    if (empty($errors)) {
        ...
        $updateQuery = $conn->prepare("UPDATE user SET fname = ?, lname = ?, phone = ?, department = ?, experience = ?, bio = ? WHERE userID = ?");
        $updateQuery->bind_param("ssssssi", $firstName, $lastName, $phone, $department, $experience, $bio, $userID);
...
$statsQuery = $conn->prepare("SELECT level, points FROM user WHERE userID = ?");
...
<body class="bg-gray-50">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm">
                    ...
                    <div class="p-6">
                        ...
                        <div id="emailOtpSection" class="hidden mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                            <h3 class="font-semibold text-green-900 mb-3">Verify Your New Email</h3>
                            <p class="text-sm text-green-800 mb-4">We've sent a verification code to <span id="newEmailDisplay" class="font-medium"></span></p>
                ...
                <div class="bg-white rounded-xl shadow-sm">
                    ...
                    <div class="p-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" id="current-password" name="current_password" required 
                                           class="w-full px-4 py-2 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500">
                        ...
                        <div id="passwordOtpSection" class="hidden mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                            <h3 class="font-semibold text-green-900 mb-3">Verify Your Identity</h3>
                            <p class="text-sm text-green-800 mb-4">We've sent a verification code to <span class="font-medium"><?= htmlspecialchars($user['email']) ?></span></p>
    ...
    <script>
        ...
        // Change Password Form - Step 1: Verify Current Password, then Request OTP
